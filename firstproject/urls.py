...
from users.views import (CustomConfirmEmailView, CustomPasswordResetDoneView, CustomPasswordResetFromKeyView,
                         CustomPasswordResetFromKeyDoneView, CustomPasswordResetView, CustomLoginView, CustomSignupView)
urlpatterns = [
